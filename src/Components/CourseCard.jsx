...
const CourseCard = ({categorie='default',nameOfCourse='default',descriptionOfCourse='default', courseDuration='default',courseModules='default',courseDate='default', authorName='default',authorTitle='default'}) => {
  return (
    <div class="shadow px-4 py-5 border-b-4 border-gray-800 md:max-w-sm md:mr-5 mb-6  ">
              <h5 class="mb-2 text-sm text-gray-600">{categorie}</h5>
              ...
              <div class="mt-10 flex items-center">
                ...
                <div class="ml-2">
                  <h5 class="text-xs text-gray-800">{authorName}</h5>
                  <p class="text-xs text-gray-600">{authorTitle}</p>
                </div>
              </div>
            </div>
  )
